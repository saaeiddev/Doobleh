...
export const artists: Artist[] = [
  {
    ...
    accent: '#ffb55a',
    works: [
      { id: 'kung-fu-panda-1-mr', title: 'Kung Fu Panda', titleFa: 'پاندای کونگ‌فوکار', year: '2008', type: 'Animation', character: 'Additional roles', contribution: 'Dubbing director and voice performer in the Glory dub', source: 'https://dubdb.fandom.com/wiki/%D9%BE%D8%A7%D9%86%D8%AF%D8%A7%DB%8C_%DA%A9%D9%88%D9%86%DA%AF%E2%80%8C%D9%81%D9%88%DA%A9%D8%A7%D8%B1_(Glory_Entertainment)', sourceLabel: 'The Dubbing Database' },
      { id: 'finding-nemo-mr', title: 'Finding Nemo', titleFa: 'در جستجوی نمو', year: '2003', type: 'Animation', contribution: 'Listed among notable dubbing-direction credits', source: 'https://lilit.ir/373871/', sourceLabel: 'Lilit artist archive' },
      { id: 'incredibles-mr', title: 'The Incredibles', titleFa: 'شگفت‌انگیزان', year: '2004', type: 'Animation', contribution: 'Listed among notable dubbing-direction credits', source: 'https://lilit.ir/373871/', sourceLabel: 'Lilit artist archive' }
    ]
  },
  {
    id: 'nima-raeisi',
    ...
    works: [
      ...
      { id: 'shrek-nr', title: 'Shrek', titleFa: 'شرک', year: '2001', type: 'Animation', character: 'Shrek', contribution: 'Voice of Shrek in cited Persian-dub productions', source: 'https://www.jirjirk.com/art/174387282491/pictures-personal-photos-private-life-and-nima-raisi-biography', sourceLabel: 'Jirjirk biography' }
    ]
  },
  {
    ...
    accent: '#efa34a',
    works: [
      { id: 'barnyard-mra', title: 'Barnyard', titleFa: 'رئیس مزرعه', year: '2006', type: 'Animation', character: 'Ben, Dag, Randall, farmer', contribution: 'Dubbing director and multiple character voices in the Glory dub', source: 'https://dublove.blogfa.com/post/38/', sourceLabel: 'DubLove dubbing credits' },
      { id: 'dirin-dirin-mra', title: 'Dirin Dirin', titleFa: 'دیرین دیرین', type: 'Series', contribution: 'Principal voice performance for the animated series', source: 'https://www.sarpoosh.com/art-cinema/actors-director/actors-director1401052146.html', sourceLabel: 'Sarpoosh' }
    ]
  },
  {
    id: 'hamed-azizi',
    ...
    accent: '#ffb55a',
    works: [
      { id: 'kung-fu-panda-ha', title: 'Kung Fu Panda', titleFa: 'پاندای کونگ‌فوکار', year: '2008', type: 'Animation', character: 'Po', contribution: 'Persian voice of Po', source: 'https://www.tasnimnews.ir/fa/news/1397/02/01/1705430/', sourceLabel: 'Tasnim interview' },
      { id: 'elephant-king-ha', title: 'The Elephant King', titleFa: 'فیلشاه', year: '2018', type: 'Animation', character: 'Shadfil', contribution: 'Voice of Shadfil', source: 'https://www.tasnimnews.ir/fa/news/1397/02/01/1705430/', sourceLabel: 'Tasnim interview' },
      { id: 'kung-fu-panda-2-ha', title: 'Kung Fu Panda 2', titleFa: 'پاندای کونگ‌فوکار ۲', year: '2011', type: 'Animation', character: 'Po', contribution: 'Voice of Po and dubbing director in the cited dub', source: 'https://dubdb.fandom.com/wiki/%D9%BE%D8%A7%D9%86%D8%AF%D8%A7%DB%8C_%DA%A9%D9%88%D9%86%DA%AF%E2%80%8C%D9%81%D9%88%DA%A9%D8%A7%D8%B1_%DB%B2_(Qualima)', sourceLabel: 'The Dubbing Database' }
    ]
  },
  {
    id: 'majid-habibi',
    ...
    accent: '#dca85a',
    works: [
      { id: 'barnyard-mh', title: 'Barnyard', titleFa: 'رئیس مزرعه', year: '2006', type: 'Animation', character: 'Otis', contribution: 'Persian voice of Otis', source: 'https://www.youtube.com/watch?v=VFSPJASSvRE', sourceLabel: 'Majid Habibi official YouTube' },
      { id: 'avatar-mh', title: 'Avatar: The Last Airbender', titleFa: 'آواتار: آخرین بادافزار', type: 'Series', character: 'Zuko', contribution: 'Persian voice of Zuko in the cited dub', source: 'https://www.youtube.com/watch?v=VFSPJASSvRE', sourceLabel: 'Majid Habibi official YouTube' },
      { id: 'cars-mh', title: 'Cars', titleFa: 'ماشین‌ها', year: '2006', type: 'Animation', character: 'Lightning McQueen', contribution: 'Persian voice of Lightning McQueen in the cited dub', source: 'https://www.youtube.com/watch?v=VFSPJASSvRE', sourceLabel: 'Majid Habibi official YouTube' }
    ]
  },
  {
    ...
    accent: '#ffc875',
    works: [
      { id: 'spongebob-mrs', title: 'SpongeBob SquarePants', titleFa: 'باب‌اسفنجی شلوارمکعبی', type: 'Series', character: 'SpongeBob, Patrick and other male characters in cited versions', contribution: 'Multiple character voices and dubbing direction in cited Persian versions', source: 'https://mdcartoon.blogfa.com/post/84', sourceLabel: 'Interview archive' },
      { id: 'cars-mrs', title: 'Cars', titleFa: 'ماشین‌ها', year: '2006', type: 'Animation', character: 'Mater', contribution: 'Persian voice of Mater and dubbing direction', source: 'https://mdcartoon.blogfa.com/post/84', sourceLabel: 'Interview archive' },
      { id: 'ice-age-mrs', title: 'Ice Age', titleFa: 'عصر یخبندان', type: 'Animation', character: 'Sid', contribution: 'Persian voice of Sid in cited productions', source: 'https://mdcartoon.blogfa.com/post/84', sourceLabel: 'Interview archive' }
    ]
  },
  {
    id: 'ebrahim-shafiei',
    ...
    accent: '#efa34a',
    works: [
      { id: 'spongebob-es', title: 'SpongeBob SquarePants', titleFa: 'باب‌اسفنجی', type: 'Series', character: 'Patrick', contribution: 'Persian voice of Patrick in cited productions', source: 'https://www.youtube.com/watch?v=FpNdPpzdu3U', sourceLabel: 'AnimotionArt interview' },
      { id: 'alvin-es', title: 'Alvin and the Chipmunks', titleFa: 'آلوین و سنجاب‌ها', type: 'Film', character: 'Theodore', contribution: 'Persian voice of Theodore', source: 'https://www.youtube.com/watch?v=FpNdPpzdu3U', sourceLabel: 'AnimotionArt interview' },
      { id: 'shrek-es', title: 'Shrek', titleFa: 'شرک', type: 'Animation', character: 'Puss in Boots and additional roles', contribution: 'Voice performance in cited Persian-dub productions', source: 'https://www.youtube.com/watch?v=FpNdPpzdu3U', sourceLabel: 'AnimotionArt interview' }
    ]
  },
  {
    id: 'hooman-khayyat',
    ...
    accent: '#ffb55a',
    works: [
      { id: 'pink-panther-hk', title: 'The Pink Panther', titleFa: 'پلنگ صورتی', year: '2020', type: 'Audio', contribution: 'Narrated audio adaptation for Radio Savina', source: 'https://podcasts.apple.com/us/podcast/%D9%87%D9%88%D9%85%D9%86-%D8%AE%DB%8C%D8%A7%D8%B7/id1519582898', sourceLabel: 'Apple Podcasts' },
      ...
      { id: 'inside-out-hk', title: 'Inside Out', titleFa: 'درون و بیرون', year: '2015', type: 'Animation', contribution: 'Listed among Tehran Dubshow dubbing-direction credits', source: 'https://lilit.ir/373873/', sourceLabel: 'Lilit artist archive' }
    ]
  }
];
